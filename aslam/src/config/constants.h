...
#define NUM_PARTICLES_PER_OBJECT_MAP 1000

#define NUM_COMBINED_STATE_PARTICLES 10
...
#define BYTES_PER_MESSAGE(NUM_OBJECTS) (NUM_OBJECTS * BYTES_PER_COLOR) + (NUM_OBJECTS * NUM_PARTICLES_PER_OBJECT_MAP * BYTES_PER_POINT)
