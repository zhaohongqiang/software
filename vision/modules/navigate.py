...
options = [
        options.IntOption('adaptive_thresh_block_size', 311, 1, 2500),
        options.IntOption('adaptive_thresh_c', 8, 0, 20),
        ...
        options.DoubleOption('min_area', 200, 0, 1000),
        options.IntOption('kernel_size', 4, 1, 255),
        options.DoubleOption('min_aspect_ratio', 3.0, 1.0, 6.0),
